class Internal::SettingsController < Internal::BaseController
  ...
  def name
    ...
    render_422(:name_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def email
    ...
    render_422(:email_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def password
    ...
    render_422(:password_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def locale
    ...
    render_422(:locale_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def handle
    ...
    render_422(:handle_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def notification
    ...
    render_422(:notification_update_failed, report: false, errors: e.record.errors.as_json)
  end
  ...
  def streaks
    ...
    render_422(:streaks_update_failed, report: false, errors: e.record.errors.as_json)
  end
end
