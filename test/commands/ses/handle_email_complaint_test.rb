require "test_helper"
require_relative "../../../app/commands/ses/handle_email_complaint"

module SES
  class HandleEmailComplaintTest < ActiveSupport::TestCase
    test "handles spam complaint and unsubscribes from marketing" do
      ...
      user.reload
      refute user.data.marketing_emails_enabled?
    ...
    test "handles multiple complained recipients" do
      ...
      user1.reload
      user2.reload
      refute user1.data.marketing_emails_enabled?
      refute user2.data.marketing_emails_enabled?
    end
